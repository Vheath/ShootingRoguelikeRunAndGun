...
public class WorldScrolling : MonoBehaviour
{
    ...
    [SerializeField] int terrainTileHorizontalCount = 4;
    [SerializeField] int terrainTileVerticalCount;
    [SerializeField] float tileSize = 20.5f;
    ...
    public void Add(GameObject tilegameObject, Vector2Int tilePostition)
    {
        terrainTiles[tilePostition.x, tilePostition.y] = tilegameObject;
    }
}
